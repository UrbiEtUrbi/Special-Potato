...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
    {
        ...
        pidColor1 = Shader.PropertyToID("Color1");
        pidColor2 = Shader.PropertyToID("Color2");
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
      //  Debug.Log($"Execute");
        ...
        //---Custom effect here---
        var customEffect = stack.GetComponent<ColorLookup4>();
        // Only process if the effect is active
        if (customEffect.IsActive())
        {
            
            var material = materials.customEffect;
            material.SetColor(pidColor1, customEffect.fromColor1.value);
            material.SetColor(pidColor2, customEffect.fromColor2.value);
            BlitTo(material);
        }
